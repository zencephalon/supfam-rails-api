...
class InvalidName___Class_0x00___CodeLiteral_27 < String
  def inspect; end
end
...
class Aws::STS::Types::AssumeRoleRequest < Anonymous_Struct_28
  include Aws::Structure
end
...
class Aws::STS::Types::AssumeRoleResponse < Anonymous_Struct_29
  include Aws::Structure
end
...
class Aws::STS::Types::AssumeRoleWithSAMLRequest < Anonymous_Struct_30
  include Aws::Structure
end
...
class Aws::STS::Types::AssumeRoleWithSAMLResponse < Anonymous_Struct_31
  include Aws::Structure
end
...
class Aws::STS::Types::AssumeRoleWithWebIdentityRequest < Anonymous_Struct_32
  include Aws::Structure
end
...
class Aws::STS::Types::AssumeRoleWithWebIdentityResponse < Anonymous_Struct_33
  include Aws::Structure
end
...
class Aws::STS::Types::AssumedRoleUser < Anonymous_Struct_34
  include Aws::Structure
end
...
class Aws::STS::Types::Credentials < Anonymous_Struct_35
  include Aws::Structure
end
...
class Aws::STS::Types::DecodeAuthorizationMessageRequest < Anonymous_Struct_36
  include Aws::Structure
end
...
class Aws::STS::Types::DecodeAuthorizationMessageResponse < Anonymous_Struct_37
  include Aws::Structure
end
...
class Aws::STS::Types::ExpiredTokenException < Anonymous_Struct_38
  include Aws::Structure
end
...
class Aws::STS::Types::FederatedUser < Anonymous_Struct_39
  include Aws::Structure
end
...
class Aws::STS::Types::GetAccessKeyInfoRequest < Anonymous_Struct_40
  include Aws::Structure
end
...
class Aws::STS::Types::GetAccessKeyInfoResponse < Anonymous_Struct_41
  include Aws::Structure
end
...
class Aws::STS::Types::GetCallerIdentityResponse < Anonymous_Struct_42
  include Aws::Structure
end
...
class Aws::STS::Types::GetFederationTokenRequest < Anonymous_Struct_43
  include Aws::Structure
end
...
class Aws::STS::Types::GetFederationTokenResponse < Anonymous_Struct_44
  include Aws::Structure
end
...
class Aws::STS::Types::GetSessionTokenRequest < Anonymous_Struct_45
  include Aws::Structure
end
...
class Aws::STS::Types::GetSessionTokenResponse < Anonymous_Struct_46
  include Aws::Structure
end
...
class Aws::STS::Types::IDPCommunicationErrorException < Anonymous_Struct_47
  include Aws::Structure
end
...
class Aws::STS::Types::IDPRejectedClaimException < Anonymous_Struct_48
  include Aws::Structure
end
...
class Aws::STS::Types::InvalidAuthorizationMessageException < Anonymous_Struct_49
  include Aws::Structure
end
...
class Aws::STS::Types::InvalidIdentityTokenException < Anonymous_Struct_50
  include Aws::Structure
end
...
class Aws::STS::Types::MalformedPolicyDocumentException < Anonymous_Struct_51
  include Aws::Structure
end
...
class Aws::STS::Types::PackedPolicyTooLargeException < Anonymous_Struct_52
  include Aws::Structure
end
...
class Aws::STS::Types::PolicyDescriptorType < Anonymous_Struct_53
  include Aws::Structure
end
...
class Aws::STS::Types::RegionDisabledException < Anonymous_Struct_54
  include Aws::Structure
end
...
class Aws::STS::Types::Tag < Anonymous_Struct_55
  include Aws::Structure
end
