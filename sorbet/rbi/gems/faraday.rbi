...
class Faraday::RequestOptions < Anonymous_Faraday_Options_58
  def []=(key, value); end
  def stream_response?; end
end
class Anonymous_Faraday_Options_59 < Faraday::Options
  def ca_file; end
  def ca_file=(_); end
  def ca_path; end
  def ca_path=(_); end
...
class Faraday::SSLOptions < Anonymous_Faraday_Options_59
  def disable?; end
  def verify?; end
end
class Anonymous_Faraday_Options_60 < Faraday::Options
  def password; end
  def password=(_); end
  def self.[](*arg0); end
  def self.inspect; end
...
class Faraday::ProxyOptions < Anonymous_Faraday_Options_60
...
class Anonymous_Faraday_Options_61 < Faraday::Options
  def builder; end
  def builder=(_); end
...
class Faraday::ConnectionOptions < Anonymous_Faraday_Options_61
  def builder_class; end
  def new_builder(block); end
  def request; end
  def ssl; end
end
class Anonymous_Faraday_Options_62 < Faraday::Options
  def method; end
  def method=(_); end
  def parallel_manager; end
  def parallel_manager=(_); end
...
class Faraday::Env < Anonymous_Faraday_Options_62
  def [](key); end
  def []=(key, value); end
  def body; end
  def body=(value); end
...
class Faraday::Request < Anonymous_Struct_63
  def [](key); end
  def []=(key, value); end
  def headers=(hash); end
